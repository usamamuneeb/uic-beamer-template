...
# svg_path = "COL.ENG.ECE.LOCKC.SM.RGB.SVG" # RGB Logo
svg_path = "COL.ENG.ECE.LOCKC.SM.INVT.RGB.SVG" # Inverted RGB Logo
...
# background_color = (242, 247, 235)  # This color is Expo White
